...
- [x] App name, subtitle, promotional text, description, and keywords prepared.
- [x] Three current 6.9-inch iPhone screenshots prepared and visually reviewed.
- [x] App icon included in the uploaded build and copied into this package.
- [x] Cross-platform privacy policy deployed and verified.
- [x] Support page deployed and verified.
- [ ] **OWNER ACTION:** confirm the copyright holder and optional marketing URL.
...
- [ ] Complete App Privacy using `privacy-answers.md`.
- [ ] Complete content rights (`No` third-party content) and export compliance.
