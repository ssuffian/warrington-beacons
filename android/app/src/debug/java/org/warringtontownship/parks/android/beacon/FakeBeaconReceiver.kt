 ...
 *     -a org.warringtontownship.parks.FAKE_BEACON --ei minor 7 --ef distance 2.5
 *
 * Fake several beacons at once ("minor:distance" pairs):
 *
 *   adb shell am broadcast \
 *     -n org.warringtontownship.parks.android/.beacon.FakeBeaconReceiver \
 *     -a org.warringtontownship.parks.FAKE_BEACON --es beacons "7:2.5,8:10,4001:40"
 *
 * Clear all fake beacons (as if you walked out of range):
 *
 *   adb shell am broadcast \
 *     -n org.warringtontownship.parks.android/.beacon.FakeBeaconReceiver \
 *     -a org.warringtontownship.parks.FAKE_BEACON_CLEAR
 *
...
class FakeBeaconReceiver : BroadcastReceiver() {
    ...
    private companion object {
        ...
        const val ACTION_FAKE_BEACON = "org.warringtontownship.parks.FAKE_BEACON"
        const val ACTION_FAKE_BEACON_CLEAR = "org.warringtontownship.parks.FAKE_BEACON_CLEAR"
